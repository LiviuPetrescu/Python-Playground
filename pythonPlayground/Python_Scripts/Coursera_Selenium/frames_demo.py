...
action.move_to_element(driver.find_element(By.CSS_SELECTOR, "div[class='nav-outer clearfix'] a[class='dropdown-toggle']")).click().perform()
time.sleep(2)

# Click on the "About us" element
action.move_to_element(driver.find_element(By.CSS_SELECTOR, "ul[class='dropdown-menu'] a[href='about-my-mission']")).click().perform()
